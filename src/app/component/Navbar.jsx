        ...
        <div className='sub'>
          ...
          <div className='hero_card'>
            <div className='hc1 card '>
              <div className='flex'>
                <h3>Heres how you will discover YOUR FORCE!</h3>
                <p className='card_title'>
                  ...
                  top of the Corporate Ladder? Here&rsquo;s a glimpse of what you will
                  receive...
                </p>
              </div>
              <div>
            ...
            <div className='f1'>
              ...
              <ul>
                ...
                <li>
                  ...
                  today&rsquo;s Digital Revolution is going to be the norm. Are you
      ...
      <section className='bonus_section section'>
        <div className='sub'>
          <div className='bonus_sub'>
            <h2>Unlock Bonuses Worth Rs 24,789/-</h2>
            <div className='bonus_cards'>
              <div className='b_card'>
                ...
                <h4>E-book</h4>
                <p className='gray'>(Worth Rs 797)</p>
              </div>
              <div className='b_card'>
                ...
                <h4>Assessment</h4>
                <p className='gray'>(Worth Rs 8993)</p>
              </div>
              <div className='b_card'>
